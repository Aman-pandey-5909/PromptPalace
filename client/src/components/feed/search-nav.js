...
const SearchNav = () => {
  ...
  return (
    <div className="flex justify-center items-center-safe relative">
      ...
      <Button className={'absolute right-1/4 border-l-1 rounded-l-none border-black  transition-all mt-2 flex justify-center-safe items-center-safe hover:bg-gray-100'} variant={'ghost'}>
        <SearchIcon />
      </Button>
    </div>
  )
