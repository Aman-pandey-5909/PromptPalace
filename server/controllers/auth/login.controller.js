...
exports.login = async (req, res) => {
    try {
        ...
        loginCache.set(token, Date.now() + 24 * 60 * 60 * 1000) // cache the token with its value as expiration time
        userDataCache.set(token, { id: existingUser.id, email: existingUser.email, username: existingUser.username })
        ...
        console.log("LoginTokens: ", [...loginCache.entries()]);
        console.log("UserTokens: ", [...userDataCache.entries()]);
